...
export class AuthenticationService {
  ...
  async updateUser(user: User) {
    ...
    try {
      const docRef = doc(firestore, "users", user.id);
      await updateDoc(docRef, { title: user.title, artist: user.artist, streams: user.streams, releaseDate: user.releaseDate, genres: user.genres, isExplicit: user.isExplicit });
    } catch (e) {
